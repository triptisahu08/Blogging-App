...
class _FoodBlogState extends State<FoodBlog> {
  ...
  void initState() {
    ...
    super.initState();
    _foodRef = FirebaseDatabase.instance
        .reference()
        .child('BlogDetails')
        .child('Food');
  }
            ...
            children: [
              ...
              GestureDetector(
                child: Icon(Icons.edit,
                    color: Colors.red[100], textDirection: TextDirection.ltr),
                onTap: () {
                  updateData(context, blog['Key'], blog['type'],
                      blog['blog_title'], blog['description']);
                  //updateData();
                },
              ),
            ],

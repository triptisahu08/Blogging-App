...
class ItBlog extends StatefulWidget {
  @override
  _ItBlogState createState() => _ItBlogState();
}

class _ItBlogState extends State<ItBlog> {
  ...
  void initState() {
    ...
    super.initState();
    _itRef = FirebaseDatabase.instance.reference().child('BlogDetails').child('It');
  }
  ...
  Widget build(BuildContext context) {
    ...
    elevation: 0.0,
    title:Text('IT BLOGS',style: TextStyle(fontSize: 20,color:Colors.redAccent,),),
    ),
      body: Container(
        decoration: new BoxDecoration(
          color: Colors.black45,

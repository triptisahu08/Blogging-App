...
class TravelBlog extends StatefulWidget {
  @override
  _TravelBlogState createState() => _TravelBlogState();
}

class _TravelBlogState extends State<TravelBlog> {
  DatabaseReference _travelRef;
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    _travelRef = FirebaseDatabase.instance.reference().child('BlogDetails').child('Travel');
  }
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        ...
        elevation: 0.0,
        title:Text('Travel BLOGS',style: TextStyle(fontSize: 20,color:Colors.redAccent,),),
      ),
      body: Container(
        decoration: new BoxDecoration(
          color: Colors.black45,
